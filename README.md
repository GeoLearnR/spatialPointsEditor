...
- 🗺️ **Interactive Map Interface**: Visualize points on OpenStreetMap or satellite imagery
- 🖱️ **Drag-and-Drop Editing**: Click and drag markers to new positions
- 📊 **Multiple Edit Methods**: Edit via map, data table, or manual coordinate entry
- ↩️ **Undo/Redo**: Full history tracking with unlimited undo/redo
- 📝 **Modification Logging**: Track all changes with detailed before/after comparison
- 🎨 **Visual Feedback**: Color-coded points (original, modified, selected)
- 💾 **Export Changes**: Download a CSV log of all coordinate corrections
- 🌐 **CRS Support**: Automatic handling of coordinate reference systems
...
- 🔵 **Blue**: Original, unmodified points
- 🟠 **Orange**: Modified points
- 🔴 **Red**: Currently selected point (draggable)
